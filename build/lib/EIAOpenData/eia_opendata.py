...
class EIAOpenData:
    ...
    def build_url(self, route, data_param, frequency=None, start_date=None, end_date=None, facet_name=None, facet_values=None):
        """
        ...
        :param facet_values: A list of facet values.
        ...
        if facet_name and facet_values:
            facet_str = f"&facets[{facet_name}][]=" + "&facets[{}][]=".format(facet_name).join(facet_values)
            url += facet_str

        return url

    def get_data(self, route, data_param, frequency=None, start_date=None, end_date=None, facet_name=None, facet_values=None):
        """
        ...
        url = self.build_url(route, data_param, frequency, start_date, end_date, facet_name, facet_values)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'response' in data and 'data' in data['response']:
                    ...
                    raise EIAOpenDataError("Response data format is not as expected.")
            else:
